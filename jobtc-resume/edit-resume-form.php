            ...
            <div class="section_content">
                ...
                <form action="//vidhire.net/edit-resume/?edit=57" method="post" enctype="multipart/form-data" id="submit_form" class="submit_form main_form">
                    <fieldset>
                        ...
                        <p class="optional"><label for="desired_salary">Hourly Rate or Yearly Salary</label> <input type="text" class="text" name="desired_salary" id="desired_salary" placeholder="e.g. 10" value="23"></p>
